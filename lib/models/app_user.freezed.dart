...
abstract class $AppUserCopyWith<$Res> {
  ...
  $Res call({
    ...
    @JsonKey(name: 'penalty_points') int penaltyPoints,
  });
}
...
class _$AppUserImpl implements _AppUser {
  const _$AppUserImpl({
    ...
    this.phone,
    @JsonKey(name: 'dormitory_id') this.dormitoryId,
    @JsonKey(name: 'room_number') this.roomNumber,
    @JsonKey(name: 'is_admin') this.isAdmin = false,
    @JsonKey(name: 'penalty_points') this.penaltyPoints = 0,
  });
  ...
  @override
  String toString() {
    return 'AppUser(id: $id, email: $email, fullName: $fullName, phone: $phone, dormitoryId: $dormitoryId, roomNumber: $roomNumber, isAdmin: $isAdmin, penaltyPoints: $penaltyPoints)';
  }
...
abstract class _AppUser implements AppUser {
  const factory _AppUser({
    ...
    final String? phone,
    @JsonKey(name: 'dormitory_id') final String? dormitoryId,
    @JsonKey(name: 'room_number') final String? roomNumber,
    @JsonKey(name: 'is_admin') final bool isAdmin,
    @JsonKey(name: 'penalty_points') final int penaltyPoints,
  }) = _$AppUserImpl;
